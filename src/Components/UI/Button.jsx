...
const Button = forwardRef(({ 
    ...
    const variants = {
        ...
        danger: "bg-red-500 hover:bg-red-600 text-white shadow-sm hover:shadow-md border-0 rounded-lg",
        success: "bg-green-500 hover:bg-green-600 text-white shadow-sm hover:shadow-md border-0 rounded-lg"
    };

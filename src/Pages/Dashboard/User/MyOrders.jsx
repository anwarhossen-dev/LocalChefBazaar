...
//               <div>
//                 <h3 className="font-semibold text-lg">{order.mealName}</h3>
//                 <p className="text-gray-600">{format(new Date(order.orderTime), "dd MMM yyyy, hh:mm a")}</p>
//                 <p className="text-sm text-gray-500 mt-1 mb-2">{order.quantity} items • ${order.price}</p>
//                 <span className={`px-4 py-2 rounded-full text-sm font-medium ${
//                   order.orderStatus === "delivered" ? "bg-green-100 text-green-700" :
//                   order.orderStatus === "rejected" ? "bg-red-300 text-red-800" :
//                   "bg-yellow-300 text-yellow-800"
//                 }`}>
//                   {order.orderStatus}
//                 </span>
...
//                 order.paymentStatus === "pending" ? "bg-yellow-300 text-yellow-800" :
